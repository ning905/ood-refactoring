...
describe("Cinema", () => {
  ...
  it("creates new screens", () => {
    ...
    const result = cinema.getScreens();

    expect(result.name).toEqual(expected.name);
    expect(result.capacity).toEqual(expected.capacity);
    expect(result.showings).toEqual(expected.showings);
  });
  ...
  it("adds new films", () => {
    ...
    const result = cinema.getFilms();
    expect(result.name).toEqual(expected.name);
    expect(result.rating).toEqual(expected.rating);
